...
{
    private DB DB;
    private LevelMainForm mainForm;
    ...
    {
        plotView1.Size = new Size(Width - _rightGraphIndexnt, Height - _botomGraphIndention);
        listBox1.Size = new Size(120, Height - label1.Size.Height - 25);
    }
    ...
    private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        graphic.localStraightPoints = new DPoint[2] { new(startX, startY), new(endX, endY) };
        graphic.RefreshPlot();
    }
