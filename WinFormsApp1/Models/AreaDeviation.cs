...
public class AreaDeviation
{
    ...
    public AreaDeviation((int x, decimal y) firstCoord, (int x, decimal y) secondCoord, decimal deviation,
        AreaDeviation? prevArea, AreaDeviation? nextArea)
    {
    ...
    public AreaDeviation((int x, decimal y) firstCoord, (int x, decimal y) secondCoord, decimal deviation) : this(
        firstCoord, secondCoord, deviation, null, null)
    {
    }

    public AreaDeviation(int x1, decimal y1, int x2, decimal y2, decimal deviation) : this((x1, y1), (x2, y2),
        deviation, null, null)
    {
    }
