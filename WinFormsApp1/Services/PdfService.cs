...
public class PdfService
{
    ...
    private static void AddDataListValues(Document document, string[][] dataListValues)
    {
        ...
        var cellsWidth = 17.7 / (columnMultipler * (dataListValues[0].Length - 1));
        ...
        var rowsCount = dataListValues.Length % columnMultipler == 0
            ? dataListValues.Length / columnMultipler
            : dataListValues.Length / columnMultipler + 1;
        ...
        for (var i = 1; i < rowsCount; i++)
        {
            ...
            for (var c = 0; c < columnMultipler; c++)
            {
                var koef = dataListValues.Length % columnMultipler == 0
                    ? dataListValues.Length / columnMultipler
                    : dataListValues.Length / columnMultipler + 1;
    ...
    private static void BuildDocument(Document document, string[][] dbValues, string[][] dataListValues,
        MemoryStream png)
    {
